...
If OrientationJ contributed to your results, please cite the publication matching what you used. All four are also listed, with the work that cites them, on the [use cases](use-cases/index.md) page.
...
The plugin itself is free software under the [GNU General Public License v3.0](https://github.com/Biomedical-Imaging-Group/OrientationJ/blob/master/LICENSE); the [conditions of use](installation/index.md#conditions-of-use) are on the installation page.
